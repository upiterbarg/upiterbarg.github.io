...
I worked under the guidance of Kevin A. Smith and Kelsey R. Allen in the [MIT Computational Cognitive Science Group](http://cocosci.mit.edu/) to design and to run a suite of preliminary experiments testing a novel online game as a testbed for behavioral experiments studying abstract strategy learning in humans, using a Bayesian mixture model to analyze collected strategy learning data. This project was conducted for Josh Tenenbaum's undergraduate/graduate course.
