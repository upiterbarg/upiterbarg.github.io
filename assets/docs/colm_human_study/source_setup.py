...
try:
    from loginsightwebhookdemo import (
        __version__ as loginsightwebhookdemoversion,
    )  # TODO Replace with a static variant?
except ImportError:
...
setup(
    ...
    entry_points={"console_scripts": ["li = loginsightwebhookdemo.__init__:main"]},
